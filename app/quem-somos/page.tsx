...
export default function Page(){
  ...
  return <BasicContentPage eyebrow="Quem somos" title="Presença, clareza e propósito em cada jornada." description="A Viagem Perfeita Turismo organiza experiências culturais e espirituais com atendimento próximo, preparação responsável e cuidado humano.">
    <section className="institutional-intro"><div><p className="eyebrow">Porque existimos</p><h2>Para transformar deslocamentos em experiências com significado.</h2><p>Uma viagem de fé começa na escuta. Entendemos o perfil de cada viajante e de cada grupo para construir uma jornada coerente, acolhedora e transparente — desde a primeira conversa até o retorno.</p></div><img src={`${basePath}/media/israel/jerusalem-experiencia.jpg`} alt="Registro real de uma experiência da Viagem Perfeita em Jerusalém"/></section>
