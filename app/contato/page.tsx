...
export default function Page(){return <BasicContentPage eyebrow="Contato" title="Vamos conversar sobre a sua próxima viagem." description="Preencha suas preferências e confira a solicitação antes de continuar para o WhatsApp."><div className="contact-page-grid"><div><MessageCircle/><h2>Atendimento pelo WhatsApp</h2><p>{companyContact.displayNumber}<br/>{siteConfig.business.serviceHours}</p><WhatsAppLink buttonText="Fale conosco">Fale conosco</WhatsAppLink></div>{siteConfig.business.email?<div><Mail/><h2>E-mail</h2><p>{siteConfig.business.email}</p></div>:null}</div></BasicContentPage>}
