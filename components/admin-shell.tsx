...
export function AdminShell({children,title}:{children:ReactNode;title:string}){
  ...
  if(!configured)return <main className="admin-setup"><h1>CRM preparado para conexão</h1><p>Configure as variáveis públicas do Supabase para ativar a autenticação. Nenhuma credencial é armazenada no GitHub Pages.</p><Link href="/admin/login">Voltar ao login</Link></main>;
